...
Fix compilation error on some systems due to a type in a printf() format.
[GH #22793]
...
Now C<strftime> stringifies its first argument, as before. [GH #22498]
...
XXX Generate this with:
  ...
  perl Porting/acknowledgements.pl v5.40.0..HEAD
